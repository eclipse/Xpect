...
public class XjmMethodsTest extends AbstractXjmTest {
	...
	protected static class SingleTestWithMethods {
		...
		public String toString() {
			...
			buf.append("suite org.eclipse.xpect.tests.xjm.XjmMethodsTest$SingleTestWithMethods {\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SingleTestWithMethods {\n");
	...
	protected static class SuiteWithLoop {
		...
		public String toString() {
			StringBuilder buf = new StringBuilder();
			buf.append("suite org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithLoop {\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithLoop {\n");
			buf.append("    @Test public void testMember0();\n");
			buf.append("  }\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithLoop$LoopMember1 {\n");
	...
	protected static class SuiteWithNameConflicts {
		...
		public String toString() {
			StringBuilder buf = new StringBuilder();
			buf.append("suite org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNameConflicts {\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNameConflicts {}\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNameConflicts$Conflict1 {\n");
			buf.append("    @Xpect public void noConflict();\n");
			buf.append("  }\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNameConflicts$Conflict2 {\n");
	...
	protected static class SuiteWithNesting {
		...
		public String toString() {
			StringBuilder buf = new StringBuilder();
			buf.append("suite org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNesting {\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNesting {\n");
			buf.append("    @Test public void testMember0();\n");
			buf.append("    @Xpect public void xpectMember0();\n");
			buf.append("  }\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNesting$SuiteMember1 {\n");
			buf.append("    @Test public void testMember1();\n");
			buf.append("    @Xpect public void xpectMember1();\n");
			buf.append("  }\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNesting$SuiteMember2 {\n");
			buf.append("    @Test public void testMember2();\n");
			buf.append("    @Xpect public void xpectMember2();\n");
			buf.append("  }\n");
			buf.append("  test org.eclipse.xpect.tests.xjm.XjmMethodsTest$SuiteWithNesting$SuiteMember3 {\n");
